...
import "../styles/Home.css"; // crearemos este archivo a continuación
        ...
        <div className="container">
          ...
          <div className="grid">
            <article className="card">
              ...
              <Link to="/catalogo?cat=frutas" className="btn-link">
                Explorar
              </Link>
            </article>
            ...
            <article className="card">
              <h3>Verduras</h3>
              <Link to="/catalogo?cat=verduras" className="btn-link">
                Explorar
              </Link>
            </article>
            ...
            <article className="card">
              <h3>Semillas</h3>
              <Link to="/catalogo?cat=semillas" className="btn-link">
                Explorar
              </Link>
            </article>
